...
export const resumeData: ResumeData = {
  ...
  technicalExpertise: [
    ...
    { title: 'LLMs', skills: 'Closed Flagship & Open-Weight Frontier LLMs (GPT-5.6 Sol/Cyber, Claude Fable 5, Gemini 3.5 Pro/Flash, Grok 4.20, DeepSeek V4, Kimi K3, Qwen3.8 Max, Llama 4 Scout, Nemotron 3.5)' },
  ...
  experience: [
    {
      ...
      highlights: [
        'AI Agentic Systems Engineering: Built agentic AI systems using LangChain, LangGraph, OpenAI Agents SDK, CrewAI. Designed RAG-based knowledge systems, GraphRAG, Embeddings, and Vector Search using vector databases (Pinecone, Chroma, S3 Vector). Developed production LLM systems across closed flagships (GPT-5.6 Sol/Cyber, Claude Fable 5 & Opus 5, Gemini 3.5 Pro/Flash, Grok 4.20) and open-weight frontier models (DeepSeek V4, Kimi K3, Qwen3.8 Max, Llama 4 Scout, Nemotron 3.5). Built voice AI systems using OpenAI Whisper, TTS, STT pipelines. Implemented NLP and Computer Vision systems for automation and intelligence extraction. Built AI applications using Google AI Studio, Google AntiGravity, Cursor AI. Delivered production AI systems using OpenAI, Azure AI Foundry, AWS Bedrock. Reliability: Guardrails, Retry Logic, Fallbacks, Input Validation, Output Validation, Logging, Evaluation.',
