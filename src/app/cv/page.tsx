                ...
                <div className="p-8 md:p-12 relative overflow-hidden">
                    ...
                    <div className="mb-12">
                        <motion.h1 
                            ...
                            className="text-4xl md:text-5xl lg:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-foreground to-foreground/70 tracking-tighter mb-3 uppercase"
                        >
                            {resumeData.name}
                        </motion.h1>
                        <motion.p 
