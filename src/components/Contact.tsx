  ...
  return (
    <section id="contact" className="py-16 md:py-24 lg:py-32 relative bg-background overflow-hidden">
      ...
      <div className="container relative z-10 flex justify-center">
        <Card className="w-full max-w-xl group relative flex flex-col h-full overflow-hidden rounded-xl transition-all duration-300 hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/20">
          ...
          <CardContent>
            <form ref={formRef} action={dispatch} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-muted-foreground">{t('yourName')}</Label>
