                ...
                >
                    <CarouselContent className="-ml-4 md:-ml-6">
                        {skillCategories.map((category, idx) => (
                            <CarouselItem key={category.title} className="pl-4 md:pl-6 sm:basis-1/2 lg:basis-1/3 xl:basis-1/4">
                                <motion.div
                                    initial={{ opacity: 0, y: 30 }}
                                    whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <div className="hidden sm:block">
                        <CarouselPrevious className="-left-4 lg:-left-12 border-primary/20 hover:bg-primary/10 hover:text-primary bg-background/80 backdrop-blur-sm" />
                        <CarouselNext className="-right-4 lg:-right-12 border-primary/20 hover:bg-primary/10 hover:text-primary bg-background/80 backdrop-blur-sm" />
                    </div>
                </Carousel>
            </div>
        </section>
